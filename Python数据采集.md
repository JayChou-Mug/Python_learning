...
<img src="数据采集/82.png" style="zoom:100%;" />
...
（在浏览器）展示效果如下
 ...
 <img src="数据采集/8.png"  style="zoom:33%;" />
...
<img src="数据采集/9.png" style="zoom:38%;" />
...
<img src="数据采集/10.png" style="zoom:60%;" />
...
<img src="数据采集/11.png" style="zoom:38%;" />
...
<img src="数据采集/22.png" style="zoom:100%;" />
...
<img src="数据采集/25.png" style="zoom:120%;" />
...
<img src="数据采集/26.png" style="zoom:60%;" />
...
展示前五名：
 ...
 <img src="数据采集/29.png"  style="zoom:60%;" />
...
```
 ...
 <img src="数据采集/30.png"  style="zoom:60%;" />
...
<img src="数据采集/31.png" style="zoom:100%;" />
...
爬取目标：`https://tianqi.2345.com/wea_history/54511.htm`,这里展示的是北京的历史天气，"北京市历史天气"的右边可以查看不同年份和月份的数据
 ...
 <img src="数据采集/32.png"   style="zoom:50%;" />
...
<img src="数据采集/64.png" style="zoom:40%;" />
...
```
 ...
 <img src="数据采集/40.png"  style="zoom: 50%;" />

 <img src="数据采集/41.png"  style="zoom:50%;" />
...
2. 如果网站有反爬措施，就需要打开该网页源代码，在 网络 - 标头 的最低端找到请求头![](数据采集/77.png)在使用`requests`的`get`或者`pose`方法时，将请求头`headers`与`URL`一同传入。
3. 对于后台加载页面的网站，还需要经过抓包处理。在源代码中找到`响应`中的数据作为参数`params`传入`.get()`。![](数据采集/78.png)
